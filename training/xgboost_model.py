...
# Train model
xgb_model = XGBClassifier(n_estimators=100, eval_metric='logloss', random_state=42)  # Removed use_label_encoder
...
print("XGBoost pipeline saved as 'xgb_pipeline.pkl'.")